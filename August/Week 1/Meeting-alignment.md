...
| **Professors** | Prof. Dr. Michelle Discacciati (Faculty of Pharmaceutical Sciences / University Hospital — USP), Prof. Dr. Nina S. T. Hirata (IME-USP)|
| **Duration** | 2 hours |
| **Type** | Interdisciplinary technical meeting (problem specification)|
...
The exchange went in both directions. From our side, we presented what deep learning can and cannot realistically deliver on this kind of problem. From Michelle's side, we received the cytopathological grounding: how a cervical cytology slide is prepared, how a cytopathologist actually reads it, and what the diagnostic categories mean.
